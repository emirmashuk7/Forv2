...
class Config:
    ...
    BOT_TOKEN = environ.get("BOT_TOKEN", "8758810792:AAHule-rJfnZvSiIJoP432GruxE3qYwFcz0") 
    BOT_SESSION = environ.get("BOT_SESSION", "your_session_string_here") 
    DATABASE_URI = "mongodb+srv://emirmashuk77:Emirmashuk7860@cluster0.zdfun6c.mongodb.net/forv2db?appName=Cluster0"
